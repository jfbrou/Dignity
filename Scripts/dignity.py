...
micro = survival.loc[survival.year.isin(range(1984, 2020 + 1)), :]
micro.loc[:, 'micro'] = True
macro = survival.loc[survival.year.isin(list(range(1940, 1990 + 1, 10)) + list(range(2000, 2020 + 1))), :]
survival = micro.append(macro, ignore_index=True)
survival.loc[survival.micro.isna(), 'micro'] = False
...
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [-1], 'latin': [-1], 'gender': [-1], 'micro': [True]}), df, how='left')
...
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [1, 2], 'latin': [-1], 'gender': [-1], 'micro': [True]}), df, how='left')
df.loc[:, names_log + names] = df.groupby(['year', 'race'], as_index=False)[names_log + names].transform(lambda x: filter(x, 1600)).values
df_consumption = df_consumption.append(df, ignore_index=True)

# Calculate CEX consumption statistics by year, gender and age
df = pd.merge(cex.groupby(['year', 'gender', 'age'], as_index=False).agg(d_functions_log).rename(columns=d_names_log),
              cex.groupby(['year', 'gender', 'age'], as_index=False).agg(d_functions).rename(columns=d_names), how='left')
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [-1], 'latin': [-1], 'gender': [1, 2], 'micro': [True]}), df, how='left')
df.loc[:, names_log + names] = df.groupby(['year', 'gender'], as_index=False)[names_log + names].transform(lambda x: filter(x, 1600)).values
df_consumption = df_consumption.append(df, ignore_index=True)

# Calculate CEX consumption statistics by year, race, gender and age
df = pd.merge(cex.loc[cex.race.isin([1, 2]), :].groupby(['year', 'race', 'gender', 'age'], as_index=False).agg(d_functions_log).rename(columns=d_names_log),
              cex.loc[cex.race.isin([1, 2]), :].groupby(['year', 'race', 'gender', 'age'], as_index=False).agg(d_functions).rename(columns=d_names), how='left')
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [1, 2], 'latin': [-1], 'gender': [1, 2], 'micro': [True]}), df, how='left')
df.loc[:, names_log + names] = df.groupby(['year', 'race', 'gender'], as_index=False)[names_log + names].transform(lambda x: filter(x, 1600)).values
df_consumption = df_consumption.append(df, ignore_index=True)
...
# Calculate CEX consumption statistics by year, gender and age for Latinos
df = pd.merge(cex.loc[(cex.latin == 1) & (cex.year >= 2006), :].groupby(['year', 'gender', 'age'], as_index=False).agg(d_functions_log).rename(columns=d_names_log),
              cex.loc[(cex.latin == 1) & (cex.year >= 2006), :].groupby(['year', 'gender', 'age'], as_index=False).agg(d_functions).rename(columns=d_names), how='left')
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [-1], 'latin': [1], 'gender': [1, 2], 'micro': [True]}), df, how='left')
df.loc[:, names_log + names] = df.groupby(['year', 'gender'], as_index=False)[names_log + names].transform(lambda x: filter(x, 1600)).values
df_consumption = df_consumption.append(df, ignore_index=True)
...
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [1, 2], 'latin': [0], 'gender': [-1], 'micro': [True]}), df, how='left')
df.loc[:, names_log + names] = df.groupby(['year', 'race'], as_index=False)[names_log + names].transform(lambda x: filter(x, 1600)).values
df_consumption = df_consumption.append(df, ignore_index=True)

# Calculate CEX consumption statistics by year, race, gender and age for non-Latinos
df = pd.merge(cex.loc[cex.race.isin([1, 2]) & (cex.latin == 0) & (cex.year >= 2006), :].groupby(['year', 'race', 'gender', 'age'], as_index=False).agg(d_functions_log).rename(columns=d_names_log),
              cex.loc[cex.race.isin([1, 2]) & (cex.latin == 0) & (cex.year >= 2006), :].groupby(['year', 'race', 'gender', 'age'], as_index=False).agg(d_functions).rename(columns=d_names), how='left')
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [1, 2], 'latin': [0], 'gender': [1, 2], 'micro': [True]}), df, how='left')
df.loc[:, names_log + names] = df.groupby(['year', 'race', 'gender'], as_index=False)[names_log + names].transform(lambda x: filter(x, 1600)).values
df_consumption = df_consumption.append(df, ignore_index=True)
...
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [-1], 'latin': [-1], 'gender': [-1], 'micro': [False]}), df, how='left')
...
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [1, 2], 'latin': [-1], 'gender': [-1], 'micro': [False]}), df, how='left')
df.loc[:, 'c_bar'] = df.groupby(['year', 'race'], as_index=False).c_bar.transform(lambda x: filter(x, 1600)).values
df_consumption = df_consumption.append(df, ignore_index=True)

# Calculate ACS consumption statistics by year, gender and age
df = acs.groupby(['year', 'gender', 'age'], as_index=False).agg({'consumption': lambda x: weighted_average(x, data=acs, weights='weight')}).rename(columns={'consumption': 'c_bar'})
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [-1], 'latin': [-1], 'gender': [1, 2], 'micro': [False]}), df, how='left')
df.loc[:, 'c_bar'] = df.groupby(['year', 'gender'], as_index=False).c_bar.transform(lambda x: filter(x, 1600)).values
df_consumption = df_consumption.append(df, ignore_index=True)

# Calculate ACS consumption statistics by year, race, gender and age
df = acs.loc[acs.race.isin([1, 2]), :].groupby(['year', 'race', 'gender', 'age'], as_index=False).agg({'consumption': lambda x: weighted_average(x, data=acs, weights='weight')}).rename(columns={'consumption': 'c_bar'})
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [1, 2], 'latin': [-1], 'gender': [1, 2], 'micro': [False]}), df, how='left')
df.loc[:, 'c_bar'] = df.groupby(['year', 'race', 'gender'], as_index=False).c_bar.transform(lambda x: filter(x, 1600)).values
df_consumption = df_consumption.append(df, ignore_index=True)
...
# Calculate ACS consumption statistics by year, gender and age for Latinos
df = acs.loc[(acs.latin == 1) & (acs.year >= 2006), :].groupby(['year', 'gender', 'age'], as_index=False).agg({'consumption': lambda x: weighted_average(x, data=acs, weights='weight')}).rename(columns={'consumption': 'c_bar'})
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [-1], 'latin': [1], 'gender': [1, 2], 'micro': [False]}), df, how='left')
df.loc[:, 'c_bar'] = df.groupby(['year', 'gender'], as_index=False).c_bar.transform(lambda x: filter(x, 1600)).values
df_consumption = df_consumption.append(df, ignore_index=True)
...
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [1, 2], 'latin': [0], 'gender': [-1], 'micro': [False]}), df, how='left')
df.loc[:, 'c_bar'] = df.groupby(['year', 'race'], as_index=False).c_bar.transform(lambda x: filter(x, 1600)).values
df_consumption = df_consumption.append(df, ignore_index=True)

# Calculate ACS consumption statistics by year, race, gender and age for non-Latinos
df = acs.loc[acs.race.isin([1, 2]) & (acs.latin == 0) & (acs.year >= 2006), :].groupby(['year', 'race', 'gender', 'age'], as_index=False).agg({'consumption': lambda x: weighted_average(x, data=acs, weights='weight')}).rename(columns={'consumption': 'c_bar'})
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [1, 2], 'latin': [0], 'gender': [1, 2], 'micro': [False]}), df, how='left')
df.loc[:, 'c_bar'] = df.groupby(['year', 'race', 'gender'], as_index=False).c_bar.transform(lambda x: filter(x, 1600)).values
df_consumption = df_consumption.append(df, ignore_index=True)
...
# Calculate CPS leisure statistics by year, gender and age
df = pd.merge(cps.groupby(['year', 'gender', 'age'], as_index=False).agg({'leisure': lambda x: weighted_average(v_of_ℓ(x), data=cps, weights='weight')}).rename(columns={'leisure': 'Ev_of_ℓ'}),
              cps.groupby(['year', 'gender', 'age'], as_index=False).agg({'leisure': lambda x: weighted_average(x, data=cps, weights='weight')}).rename(columns={'leisure': 'ℓ_bar'}), how='left')
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [-1], 'latin': [-1], 'gender': [1, 2], 'micro': [True]}), df, how='left')
df.loc[:, ['Ev_of_ℓ', 'ℓ_bar']] = df.groupby(['year', 'gender'], as_index=False)[['Ev_of_ℓ', 'ℓ_bar']].transform(lambda x: filter(x, 100)).values
df.loc[df.loc[:, 'Ev_of_ℓ'] > 0, 'Ev_of_ℓ'] = 0
df.loc[df.loc[:, 'ℓ_bar'] > 1, 'ℓ_bar'] = 1
df_leisure = df_leisure.append(df, ignore_index=True)

# Calculate CPS leisure statistics by year, race, gender and age
df = pd.merge(cps.loc[cps.race.isin([1, 2]), :].groupby(['year', 'race', 'gender', 'age'], as_index=False).agg({'leisure': lambda x: weighted_average(v_of_ℓ(x), data=cps, weights='weight')}).rename(columns={'leisure': 'Ev_of_ℓ'}),
              cps.loc[cps.race.isin([1, 2]), :].groupby(['year', 'race', 'gender', 'age'], as_index=False).agg({'leisure': lambda x: weighted_average(x, data=cps, weights='weight')}).rename(columns={'leisure': 'ℓ_bar'}), how='left')
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [1, 2], 'latin': [-1], 'gender': [1, 2], 'micro': [True]}), df, how='left')
df.loc[:, ['Ev_of_ℓ', 'ℓ_bar']] = df.groupby(['year', 'race', 'gender'], as_index=False)[['Ev_of_ℓ', 'ℓ_bar']].transform(lambda x: filter(x, 100)).values
df.loc[df.loc[:, 'Ev_of_ℓ'] > 0, 'Ev_of_ℓ'] = 0
df.loc[df.loc[:, 'ℓ_bar'] > 1, 'ℓ_bar'] = 1
df_leisure = df_leisure.append(df, ignore_index=True)
...
# Calculate CPS leisure statistics by year, gender and age for Latinos
df = pd.merge(cps.loc[(cps.latin == 1) & (cps.year >= 2006), :].groupby(['year', 'gender', 'age'], as_index=False).agg({'leisure': lambda x: weighted_average(v_of_ℓ(x), data=cps, weights='weight')}).rename(columns={'leisure': 'Ev_of_ℓ'}),
              cps.loc[(cps.latin == 1) & (cps.year >= 2006), :].groupby(['year', 'gender', 'age'], as_index=False).agg({'leisure': lambda x: weighted_average(x, data=cps, weights='weight')}).rename(columns={'leisure': 'ℓ_bar'}), how='left')
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [-1], 'latin': [1], 'gender': [1, 2], 'micro': [True]}), df, how='left')
df.loc[:, ['Ev_of_ℓ', 'ℓ_bar']] = df.groupby(['year', 'gender'], as_index=False)[['Ev_of_ℓ', 'ℓ_bar']].transform(lambda x: filter(x, 100)).values
df.loc[df.loc[:, 'Ev_of_ℓ'] > 0, 'Ev_of_ℓ'] = 0
df.loc[df.loc[:, 'ℓ_bar'] > 1, 'ℓ_bar'] = 1
...
# Calculate CPS leisure statistics by year, race, gender and age for non-Latinos
df = pd.merge(cps.loc[cps.race.isin([1, 2]) & (cps.latin == 0) & (cps.year >= 2006), :].groupby(['year', 'race', 'gender', 'age'], as_index=False).agg({'leisure': lambda x: weighted_average(v_of_ℓ(x), data=cps, weights='weight')}).rename(columns={'leisure': 'Ev_of_ℓ'}),
              cps.loc[cps.race.isin([1, 2]) & (cps.latin == 0) & (cps.year >= 2006), :].groupby(['year', 'race', 'gender', 'age'], as_index=False).agg({'leisure': lambda x: weighted_average(x, data=cps, weights='weight')}).rename(columns={'leisure': 'ℓ_bar'}), how='left')
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [1, 2], 'latin': [0], 'gender': [1, 2], 'micro': [True]}), df, how='left')
df.loc[:, ['Ev_of_ℓ', 'ℓ_bar']] = df.groupby(['year', 'race', 'gender'], as_index=False)[['Ev_of_ℓ', 'ℓ_bar']].transform(lambda x: filter(x, 100)).values
df.loc[df.loc[:, 'Ev_of_ℓ'] > 0, 'Ev_of_ℓ'] = 0
df.loc[df.loc[:, 'ℓ_bar'] > 1, 'ℓ_bar'] = 1
...
# Calculate ACS leisure statistics by year, gender and age
df = acs.groupby(['year', 'gender', 'age'], as_index=False).agg({'leisure': lambda x: weighted_average(x, data=acs, weights='leisure_weight')}).rename(columns={'leisure': 'ℓ_bar'})
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [-1], 'latin': [-1], 'gender': [1, 2], 'micro': [False]}), df, how='left')
df.loc[:, 'ℓ_bar'] = df.groupby(['year', 'gender'], as_index=False)['ℓ_bar'].transform(lambda x: filter(x, 100)).values
df.loc[df.loc[:, 'ℓ_bar'] > 1, 'ℓ_bar'] = 1
df_leisure = df_leisure.append(df, ignore_index=True)

# Calculate ACS leisure statistics by year, race, gender and age
df = acs.loc[acs.race.isin([1, 2]), :].groupby(['year', 'race', 'gender', 'age'], as_index=False).agg({'leisure': lambda x: weighted_average(x, data=acs, weights='leisure_weight')}).rename(columns={'leisure': 'ℓ_bar'})
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [1, 2], 'latin': [-1], 'gender': [1, 2], 'micro': [False]}), df, how='left')
df.loc[:, 'ℓ_bar'] = df.groupby(['year', 'race', 'gender'], as_index=False)['ℓ_bar'].transform(lambda x: filter(x, 100)).values
df.loc[df.loc[:, 'ℓ_bar'] > 1, 'ℓ_bar'] = 1
df_leisure = df_leisure.append(df, ignore_index=True)
...
# Calculate ACS leisure statistics by year, gender and age for Latinos
df = acs.loc[(acs.latin == 1) & (acs.year >= 2006), :].groupby(['year', 'gender', 'age'], as_index=False).agg({'leisure': lambda x: weighted_average(x, data=acs, weights='leisure_weight')}).rename(columns={'leisure': 'ℓ_bar'})
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [-1], 'latin': [1], 'gender': [1, 2], 'micro': [False]}), df, how='left')
df.loc[:, 'ℓ_bar'] = df.groupby(['year', 'gender'], as_index=False)['ℓ_bar'].transform(lambda x: filter(x, 100)).values
df.loc[df.loc[:, 'ℓ_bar'] > 1, 'ℓ_bar'] = 1
df_leisure = df_leisure.append(df, ignore_index=True)
...
# Calculate ACS leisure statistics by year, race, gender and age for non-Latinos
df = acs.loc[acs.race.isin([1, 2]) & (acs.latin == 0) & (acs.year >= 2006), :].groupby(['year', 'race', 'gender', 'age'], as_index=False).agg({'leisure': lambda x: weighted_average(x, data=acs, weights='leisure_weight')}).rename(columns={'leisure': 'ℓ_bar'})
df = pd.merge(expand({'year': df.year.unique(), 'age': range(101), 'race': [1, 2], 'latin': [0], 'gender': [1, 2], 'micro': [False]}), df, how='left')
df.loc[:, 'ℓ_bar'] = df.groupby(['year', 'race', 'gender'], as_index=False)['ℓ_bar'].transform(lambda x: filter(x, 100)).values
df.loc[df.loc[:, 'ℓ_bar'] > 1, 'ℓ_bar'] = 1
df_leisure = df_leisure.append(df, ignore_index=True)
