...
# Define the level consumption-equivalent welfare calculation function
def cew_level_gamma(S_i=None, S_j=None, Eu_of_c_and_ell_i=None, Eu_of_c_and_ell_j=None, age_min=0, age_max=100, gamma=2, epsilon=1, theta=8.795358530547285, # Standard parameters
